...
class TraficoMaritimoBase(models.AbstractModel):
    _name = 'trafico.maritimo.base'
    _description = 'Tráfico Marítimo Base'
    ...
    #1. BUQUE
    nave_id = fields.Many2one('nave.nave', string=_('Buque'), required=True, index=True, copy=False, tracking=True)
